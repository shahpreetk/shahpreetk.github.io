      ...
      <div className="max-w-7xl mx-auto px-2 md:px-8">
        <div className="py-4">
          {blogData.map((eachBlog) => (
            <div key={eachBlog.blogId} className={classNames((eachBlog.blogId) % 2 === 0 ? 'bg-slate-100' : 'bg-gray-100', "shadow overflow-hidden sm:rounded-lg mb-4")}>
              ...
              <div className="border-t border-slate-300 px-4 py-5 sm:px-6">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    {eachBlog.references.map((reference) => reference && (
                      <dd key={reference.referenceId} className="mt-1 text-sm text-gray-900">
                        <ul className="border-b-2 border-gray-200 divide-y divide-gray-200">
                          <li key={reference.referenceId} className="pr-4 py-2 flex items-center justify-between text-sm">
