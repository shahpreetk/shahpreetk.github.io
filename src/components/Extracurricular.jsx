              ...
              {extracurriculars.map((eachVal) => (
                <div key={eachVal.name} className="relative">
                  <dt>
                    ...
                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900 inline-block">{eachVal.name}
                      <div className="ml-2 text-violet-600 inline-block align-bottom">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500 whitespace-pre-line text-justify">{eachVal.description}</dd>
                </div>
              ))}
            </dl>
          </div>
